...
C++ type does not have a nested `hana_dataype` alias, `datatype` returns the
...
@todo
Update this for the new core/ hierarchy and try to merge this with the
file list generated by Doxygen.
