...
namespace boost { namespace hana {
    ...
    template <typename ...T>
    struct _tuple_t<T...>::_
        : _tuple_t<T...>, _tuple<decltype(make_type<T>())...>
    {
        constexpr _()
            : _tuple<decltype(make_type<T>())...>{make_type<T>()...}
        { }
    };
    ...
    struct equal_impl<Tuple, Tuple> {
        ...
        template <typename ...T>
        static constexpr _bool<true> apply(_tuple_t<T...>, _tuple_t<T...>)
        { return {}; }

        template <typename ...T, typename ...U>
        static constexpr _bool<false> apply(_tuple_t<T...>, _tuple_t<U...>)
        { return {}; }
        ...
        static constexpr auto apply(_tuple_c<V, v...>, _tuple_c<U, u...>) {
            ...
            return _bool<hana::all_of(comparisons)>{};
        }
    ...
    struct unpack_impl<Tuple> {
        ...
        { return make_type<typename F<T...>::type>(); }
    };
    ...
    struct at_impl<Tuple> {
        ...
        static constexpr decltype(auto) apply(N n, Xs&& xs) {
            constexpr detail::std::size_t index = hana::value2<decltype(n)>();
    ...
    struct is_empty_impl<Tuple> {
        template <typename Xs>
        static constexpr _bool<Xs::is_empty> apply(Xs const&)
        { return {}; }
    };
    ...
    struct drop_impl<Tuple> {
        ...
        drop_helper(Xs&& xs, detail::std::index_sequence<i...>) {
            return hana::make<Tuple>(
                        detail::get<n + i>(detail::std::forward<Xs>(xs))...);
        }

        template <typename N, typename Xs>
        static constexpr decltype(auto) apply(N n_, Xs&& xs) {
            constexpr Size n = hana::value2<decltype(n_)>();
    ...
    struct transform_impl<Tuple> {
        ...
        { return make_tuple_t<typename F<T>::type...>(); }
    ...
    struct fill_impl<Tuple> {
        ...
        { return make_tuple_t<tuple_detail::expand<!!sizeof(Xs), T>...>(); }
    };
    ...
    struct repeat_impl<Tuple> {
        ...
        static constexpr decltype(auto) apply(N n_, X&& x) {
            constexpr detail::std::size_t n = hana::value2<decltype(n_)>();
    ...
    struct init_impl<Tuple> {
        ...
        init_helper(Xs&& xs, detail::std::index_sequence<n...>) {
            return hana::make<Tuple>(
                        detail::get<n>(detail::std::forward<Xs>(xs))...);
        }
    ...
    struct remove_at_impl<Tuple> {
        ...
        template <typename N, typename Xs>
        static constexpr decltype(auto) apply(N n, Xs&& xs) {
            constexpr Size index = hana::value2<decltype(n)>();
            constexpr Size size = tuple_detail::size<Xs>{}();
    ...
    struct slice_impl<Tuple> {
        ...
        static constexpr decltype(auto) apply(Xs&& xs, From from_, To to_) {
            constexpr detail::std::size_t from = hana::value2<decltype(from_)>();
            constexpr detail::std::size_t to = hana::value2<decltype(to_)>();
    ...
    struct sort_impl<Tuple> {
        ...
        sort_helper(_tuple_c<T, v...> xs, detail::std::index_sequence<i...>) {
            ...
            return _tuple_c<T, result.values[i]...>{};
        }
